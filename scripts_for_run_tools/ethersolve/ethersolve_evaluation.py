...
jar_path = join(evaluation_path,'EtherSolve','UI','build','libs','EtherSolve-1.0-SNAPSHOT.jar')
dataset_path = join(evaluation_path,'Dataset','source/')
tmp_file_path = join(evaluation_path,'tmp','tmp_file')
result_path = 'results/'
csv_path = join(evaluation_path,'tx_top1w_ethersolve.csv')
