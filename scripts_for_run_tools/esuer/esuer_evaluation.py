...
esuer_path = join(evaluation_path,'esuer','esuer_cli.py')
...
csv_path = join(evaluation_path,'tx_top1w_esuer.csv')
...
if __name__ == '__main__':
   ...
   # os.chdir(target_path)
    ...
    for file in os.listdir(dataset_path):
        ...
        try:
                return_info = subprocess.run(['python3',esuer_path,'-O1','--output',result_path+filename,'-i',tmp_file_path],timeout=120,check=True,capture_output=True)
