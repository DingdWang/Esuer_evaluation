...
octopus_path = join(evaluation_path,'octopus','octopus_eth_evm.py')
...
csv_path = join(evaluation_path,'tx_top1w_octopus.csv')
...
if __name__ == '__main__':
   ...
   # os.chdir(target_path)
    ...
    for file in os.listdir(dataset_path):
        ...
        try:
             return_info = subprocess.run(['python3',octopus_path,'--cfg','--cfg_output',result_path+filename+'.dot','-f',tmp_file_path],timeout=120,check=True,capture_output=True)
